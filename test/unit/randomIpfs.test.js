...
!developmentChains.includes(network.name)
    ...
    : describe("Random IPFS NFT Unit Tests", function () {
          ...
          beforeEach(async () => {
              ...
              //   Setting the contract deployer
              contractDeployer = randomIpfsNftDeployment.address;
          ...
          describe("requestNft", () => {
              ...
              it("reverts if payment amount is less than mint fee", async () => {
                  const fee = await randomIpfsNft.getMintFeed();
                  await expect(
                      randomIpfsNft.requestNft({
        ...
        //                               requestNftReceipt.events[1].args
        //                                   .requestId,
        ...
        describe("getBreedFromModdedRng", () => {
            it("should return puhg if moddedRng < 10", async () => {
            ...
            it("should revert if moddedRng > 99", async function () {
                await expect(
                    randomIpfsNft.getBreedFromModdedRng(1000)
                ).to.be.revertedWithCustomError(
                    randomIpfsNft,
